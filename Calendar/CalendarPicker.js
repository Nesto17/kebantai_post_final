...
CalendarPicker.prototype._insertNavigationButtons = function () {
    ...
    var arrowSvg = '<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="451.847px" height="451.847px" viewBox="0 0 451.847 451.847" style="enable-background:new 0 0 451.847 451.847;"xml:space="preserve"><path d="M225.923,354.706c-8.098,0-16.195-3.092-22.369-9.263L9.27,151.157c-12.359-12.359-12.359-32.397,0-44.751c12.354-12.354,32.388-12.354,44.748,0l171.905,171.915l171.906-171.909c12.359-12.354,32.391-12.354,44.744,0c12.365,12.354,12.365,32.392,0,44.751L248.292,345.449C242.115,351.621,234.018,354.706,225.923,354.706z"/></svg>';

    this.previousMonthArrow.innerHTML = arrowSvg;
    this.nextMonthArrow.innerHTML = arrowSvg;

    var preArrow = this.previousMonthArrow;
    var postArrow = this.nextMonthArrow;
    preArrow.style.visibility = "hidden";

    postArrow.onclick = function () {
        preArrow.style.visibility = "visible";
        postArrow.style.visibility = "hidden";
        postArrow.style.pointerEvents = "none";
        preArrow.style.pointerEvents = "unset";
    }

    preArrow.onclick = function () {
        preArrow.style.visibility = "hidden";
        postArrow.style.visibility = "visible";
        preArrow.style.pointerEvents = "none";
        postArrow.style.pointerEvents = "unset";
    }
 ...
 */
CalendarPicker.prototype._insertDaysIntoGrid = function (param = "") {
    this.calendarGrid.innerHTML = '';

    if (param !== "") {
        let ok1 = new Date().getFullYear();
        let ok2 = new Date().getMonth();
        let ok3 = new Date().getDate();

        let final_date = new Date(ok1, ok2, ok3, 0, 0, 0);

        this.value = final_date;
    }
...
// let signupForm = document.querySelector(".content");

// signupForm.addEventListener("submit", (e) => {
//     e.preventDefault();
//     // Array.from(document.querySelectorAll('.selected')).forEach(element => element.classList.remove('selected'));
//     // let current_day = document.getElementsByTagName("time")[0];
//     // current_day.classList.add("selected")
//     // console.log(date_calender);
//     CalendarPicker.prototype = function (callback) {
//         if (this.callback) return this.callback(new Date().toDateString());
 ...
 */
CalendarPicker.prototype._updateCalendar = function (param = "") {
